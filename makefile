...
main.out:	QueryParser.o QueryLexer.o Schema.o Record.o File.o DBFile.o DataTypeClass.o Comparison.o Function.o RelOp.o Catalog.o QueryOptimizer.o QueryCompiler.o main.o
	$(CC) -o main.out main.o QueryParser.o QueryLexer.o Schema.o Record.o File.o DBFile.o DataTypeClass.o Comparison.o Function.o RelOp.o Catalog.o QueryOptimizer.o QueryCompiler.o $(lfl)
...
DataTypeClass.o : DataTypeClass.cc
